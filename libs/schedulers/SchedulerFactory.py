import torch
import math
from torch.optim.lr_scheduler import MultiStepLR, ReduceLROnPlateau, _LRScheduler, LambdaLR
...
class SchedulerFactory():
    ...
    def get(self):
        if self.name == 'MultiStepLR':
            ...
            scheduler = LambdaLR(self.optimizer, lr_lambda=lambda epoch:  0.999**epoch)
            ...
            scheduler = CosineAnnealingWarmUpRestarts(self.optimizer, **self.kwargs)
        else:
