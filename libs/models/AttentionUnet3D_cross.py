...
class _GridAttentionBlockND(nn.Module):
    ...
    def forward(self, x, g):
        ...
        :return:
        '''
        # g: torch.Size([1, 256, 8, 10, 8]) x: torch.Size([1, 129, 16, 20, 16])
...
class Attention_UNet3D(nn.Module):
    ...
    def __init__(self, emb_shape, feature_scale=4, n_classes=1, is_deconv=True, in_channels=1,
        ...
        self.attentionblock3 = MultiAttentionBlock(in_size=filters[2], gate_size=filters[3], inter_size=filters[2],
                                                   nonlocal_mode=nonlocal_mode, sub_sample_factor= attention_dsample)
        self.attentionblock4 = MultiAttentionBlock(in_size=filters[3]+1, gate_size=filters[4], inter_size=filters[3],
                                                   nonlocal_mode=nonlocal_mode, sub_sample_factor= attention_dsample)

        # upsampling
        self.up_concat4 = UnetUp3_CT(filters[4]+1, filters[3], is_batchnorm)
    ...
    def forward(self, inputs, emb_codes):
        # Feature Extraction
        ...
        conv4 = torch.cat((conv4, emb_pos), dim=1)
        # Attention Mechanism
